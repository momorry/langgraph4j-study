<script setup lang="ts">
    ...
    import { generateMarketReportV2 } from '../api/marketReportV2'
    ...
    async function handleGenerate(): Promise<void> {
        ...
        try {
            await generateMarketReportV2(body, {
    ...
    <div class="chat-layout">
        <header class="chat-header">
            ...
            <p>
                ...
                <code>/api/report-v2</code>
                流式生成简报（V2 版本，完全使用 langgraph4j 原生流式模式）。开发模式下 Vite 会将 <code>/api</code> 代理到
