...
import com.moli.langchain.agent.MarketReportAgent;
import com.moli.client.MarketReportApiClient;
import com.moli.langgraph.nodes.market.report.QueryReportsDetailNodeV3;
import com.moli.langgraph.nodes.market.report.SummaryItemNodeV2Async;
import com.moli.langgraph.nodes.market.report.SummaryMergeNodeV2;
import com.moli.langgraph.state.MarketReportStateV3;
import com.moli.common.model.MarketReportReq;
import lombok.Data;
...
public class MarketReportGraphV2 {
    ...
    private final MarketReportAgent marketReportAgent;
    ...
    public CompiledGraph<MarketReportStateV3> buildGraph() throws GraphStateException {
        return new StateGraph<>(MarketReportStateV3.SCHEMA, MarketReportStateV3::new)
                ...
                .addNode("summary_item", node_async(new SummaryItemNodeV2Async(marketReportAgent)))
                .addNode("summary_merge", node_async(new SummaryMergeNodeV2(marketReportAgent)))
