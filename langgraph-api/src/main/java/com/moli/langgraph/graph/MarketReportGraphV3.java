...
import com.moli.langgraph.nodes.market.report.RouteMergeNode;
import com.moli.langgraph.nodes.market.report.SummaryItemNode;
...
public class MarketReportGraphV3 {
    ...
    public CompiledGraph<MarketReportStateV3> buildGraph() throws GraphStateException {
        return new StateGraph<>(MarketReportStateV3.SCHEMA, MarketReportStateV3::new)
                ...
                .addNode("summary_item", node_async(new SummaryItemNode(marketReportAgent)))
