package com.moli.langgraph.app;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.moli.langchain.agent.MarketReportAgent;
import com.moli.client.MarketReportApiClient;
import com.moli.langgraph.NodeDetail;
import com.moli.langgraph.graph.MarketReportGraphV3;
import com.moli.langgraph.nodes.market.report.SummaryMergeNodeV3;
...
public class MarketReportAppV3 {
    ...
    public Flux<ServerSentEvent<String>> report(MarketReportReq marketReportReq) {
        MarketReportGraphV3 graph = new MarketReportGraphV3(marketReportApiClient, marketReportAgent);
