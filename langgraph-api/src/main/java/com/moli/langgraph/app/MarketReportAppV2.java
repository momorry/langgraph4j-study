...
import com.moli.langgraph.graph.MarketReportGraphV2;
...
public class MarketReportAppV2 {
    ...
    public Flux<ServerSentEvent<String>> report(MarketReportReq marketReportReq) {
        MarketReportGraphV2 graph = new MarketReportGraphV2(marketReportApiClient, marketReportAgent);
        ...
        serverSentEventFlux.subscribeOn(Schedulers.boundedElastic());
