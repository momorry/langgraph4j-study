...
import com.moli.langgraph.LangGraphStreaming;
...
public class SummaryMergeNodeV2 implements NodeAction<MarketReportStateV3> {
    ...
    public Map<String, Object> apply(MarketReportStateV3 state) throws Exception {
        ...
        Flux<String> flux = marketReportAgent.summaryMerge(reportItemSummary);
